                            ...
                            <div class="col-lg-12 mt-4">                                 
                                <div class="card border-0 p-4 rounded shadow">
                                    <div class="row align-items-center">
                                        <%
                                            int errInt = (request.getParameter("err")==null)?1:Integer.parseInt(request.getParameter("err"));                                            
                                        %>
                                        <%
                                            if(errInt %2==0){
                                        %>
                                        <h5 style="color: red">User name was existed!</h5>
                                        <%
                                            }
                                        %> 
                                        <%
                                            if(errInt %3==0){
                                        %>
                                        <h5 style="color: red">Email was existed!</h5>
                                        <%
                                            }
                                        %>  
                                        <%
                                            if(errInt %5==0){
                                        %>
                                        <h5 style="color: red">Phone was existed!</h5>
                                        <%
                                            }
                                        %>  
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input name="phone" id="text" type="text" class="form-control" value="${requestScope.userInfo.phone}" required required maxlength="10" pattern="[0-9]{1,10}">
                                                </div>                                                                               
                                            </div>
