...
<html>
    ...
    <body>
        ...
        <style>
            ...
            /* Banner */
            #banner-guest{
                background-image: url(assets/images/homepageBG.png);
                                ...
                                <div class="col-4">
                                    <div class="card border-primary mb-3" style="max-width: 18rem;">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class="col-2">
                                                    <img src="assets/images/homepage/class-icon.png"class="align-center" width="20px" height="20px">
                                                </div>
                                                <div class="col-10">
                                            ...
                                            <div class="row">
                                                <div class="col-2">
                                                    <img src="assets/images/homepage/teacher-icon.png"class="align-center" width="20px" height="20px">
                                                </div>
                                                <div class="col-10">
                                ...
                                <div class="col-4">
                                    <div class="card border-primary mb-3" style="max-width: 18rem;">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class="col-2">
                                                    <img src="assets/images/homepage/student-icon.png"class="align-center" width="20px" height="20px">
                                                </div>
                                                <div class="col-10">
