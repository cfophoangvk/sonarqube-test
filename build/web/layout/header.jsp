        ...
        <nav class="navbar navbar-expand-lg navbar-custom">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <c:if test="${sessionScope.name!='kiennt@gmail.com'}"><a class="nav-link nav-link-underline" href="BlogServlet">Blogs</a></c:if>
                        <c:if test="${sessionScope.name=='kiennt@gmail.com'}"><a class="nav-link nav-link-underline" href="PostServlet">Posts</a></c:if>
                        </li>   
                    </ul>
